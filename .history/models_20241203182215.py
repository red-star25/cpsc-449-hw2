...
class Book(BaseModel):
    """Pydantic model to represent a Book with validations."""
    ...
    isbn: str = Field(..., min_length=10, max_length=13, regex=r'^\d{10}(\d{3})?$', example="9780743273565")  # ISBN-10 or ISBN-13 format
...
class BookUpdate(BaseModel):
    ...
    isbn: Optional[str] = Field(None, min_length=10, max_length=13, regex=r'^\d{10}(\d{3})?$')
