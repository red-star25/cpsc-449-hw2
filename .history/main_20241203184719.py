from fastapi import (  # Importing FastAPI and HTTPException to handle requests and errors
    FastAPI, HTTPException)

from database import \
    create_connection  # Importing the custom function to create a database connection
from models import (  # Importing the Book and BookUpdate models for data validation
    Book, BookUpdate)

app = FastAPI()  # Creating an instance of FastAPI for our web application
